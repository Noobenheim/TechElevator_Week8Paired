...
<body>
    ...
    <nav>
        ...
        <ul>
            <li><a href="<c:url value="/alienAgeInput"/>">Alien Age</a></li>
            <li><a href="<c:url value="/alienWeightInput"/>">Alien Weight</a></li>
            <li><a href="<c:url value="/alienDriveTimeInput"/>">Drive Time</a></li>      
